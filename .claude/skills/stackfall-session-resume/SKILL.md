...
3. Name one next ready bead and the reason. Pass a replacement worker only the bead, relevant spec/plan slices, existing checkpoint, exact checkout/base, owned files, verification budget and evidence paths. Do not make them rediscover settled findings.
